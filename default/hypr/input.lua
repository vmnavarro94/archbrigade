...
-- etc/mkinitcpio.conf.d/archbrigade_hooks.conf.
...
-- layout that's currently active, so ArchBrigade's Latin-keysym bindings (SUPER + W
...
-- Touchpad gestures: three-finger horizontal swipe changes workspace.

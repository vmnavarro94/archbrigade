...
-- layer-shell surfaces such as ArchBrigade panels. A virtual keyboard (wtype) won't
...
o.bind("SUPER + CTRL + V", "Clipboard manager", "archbrigade-shell shell toggle archbrigade.clipboard")
